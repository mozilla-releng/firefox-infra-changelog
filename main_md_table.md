...
|:--------------------:|:-------------------------------------------:|:--------------------:| 
|[Link to commit](https://hg.mozilla.org/integration/autoland/pushloghtml?changeset=7670b6ce33a4)|Backed out 4 changesets (bug 1503393) for failing various browser-chrome tests, e.g. browser_extension_controlled.js. CLOSED TREE  Backed out changeset 52e8ef71af9b (bug 1503393) Backed out changeset 7878029aaba6 (bug 1503393) Backed out changeset 02e383b73c97 (bug 1503393) Backed out changeset 49428012434e (bug 1503393)|2018-12-03 15:28:06|
|[Link to commit](https://hg.mozilla.org/integration/autoland/pushloghtml?changeset=52e8ef71af9b)|bug 1503393 - adjust tests for localhost proxying r=mayhemer Fix test_proxy-failover_canceled and browser_firstPartyIsolation|2018-12-03 14:28:14|
|[Link to commit](https://hg.mozilla.org/integration/autoland/pushloghtml?changeset=7878029aaba6)|Bug 1503393 - Make 'no proxy' field editable r=jaws|2018-12-03 14:27:50|
|[Link to commit](https://hg.mozilla.org/integration/autoland/pushloghtml?changeset=02e383b73c97)|bug 1503393 - verify default localhost not-proxied with PAC r=mayhemer|2018-12-03 14:27:29|
|[Link to commit](https://hg.mozilla.org/integration/autoland/pushloghtml?changeset=49428012434e)|bug 1503393 - never let "localhost" get sent to a proxy r=mayhemer|2018-12-03 14:27:11|
...
|      Repository      |                   Last commit               |    Deploy time       | 
|:--------------------:|:-------------------------------------------:|:--------------------:| 
|[Link to commit](https://hg.mozilla.org/releases/mozilla-beta/pushloghtml?changeset=36afbf7b676c)|No bug - Tagging mozilla-beta e4535e943651ce499a93bbc4592cb16adab897bd with FIREFOX_RELEASE_64_BASE a=release DONTBUILD CLOSED TREE|2018-12-03 15:26:20|
|[Link to commit](https://hg.mozilla.org/releases/mozilla-beta/pushloghtml?changeset=e4535e943651)|Bug 1511516 - Update Firefox 64 to NSS 3.40.1. r=jcj, a=lizzard UPGRADE_NSS_RELEASE|2018-12-02 21:22:47|
|[Link to commit](https://hg.mozilla.org/releases/mozilla-beta/pushloghtml?changeset=cb70f86f7143)|Bug 1506447 - Check overlay before checking custom scrollbar style in nsNativeThemeCocoa::GetWidgetTransparency. r=spohl, a=lizzard  Differential Revision: https://phabricator.services.mozilla.com/D12856|2018-11-25 11:31:53|
|[Link to commit](https://hg.mozilla.org/releases/mozilla-beta/pushloghtml?changeset=729dc4b0b006)|Bug 1509576 - Fix crash when showing tooltip. r=NeilDeakin, a=lizzard  Handle the case when there is no tooltip text provider.  Differential Revision: https://phabricator.services.mozilla.com/D13105|2018-11-28 18:42:57|
|[Link to commit](https://hg.mozilla.org/releases/mozilla-beta/pushloghtml?changeset=3bebbace6e4a)|Bug 1504780 - Prevent crash if GeckoProfile path is not known. r=snorp, a=lizzard  In this case the profile name will be null, situation already handled, in which a telemetry ping about the crash will not be sent but the crash can still be reported to crash-stats.  Differential Revision: https://phabricator.services.mozilla.com/D12741|2018-11-26 19:21:56|
...
|[Link to commit](https://hg.mozilla.org/integration/mozilla-inbound/pushloghtml?changeset=bc9324a80fac)|Bug 1511811 - Minor build fixup after the Servo crossbeam_channel update. |2018-12-03 13:08:34|
|[Link to commit](https://hg.mozilla.org/integration/mozilla-inbound/pushloghtml?changeset=eeef84fe603d)|Bug 1511811 - Update crossbeam-channel to 0.3.  Cherry-picks https://github.com/servo/servo/pull/22142 |2018-11-07 18:48:07|
|[Link to commit](https://hg.mozilla.org/integration/mozilla-inbound/pushloghtml?changeset=7a36832beb55)|Bug 1511811 - Update Servo's version of encoding_rs. |2018-12-02 18:56:33|
|[Link to commit](https://hg.mozilla.org/integration/mozilla-inbound/pushloghtml?changeset=4a9fe235c6b0)|Bug 1511811 - Update mozjs and enable 'init_once' feature for Android.  Cherry-picks https://github.com/servo/servo/pull/22200 |2018-11-19 08:11:54|
...
|[Link to commit](https://hg.mozilla.org/mozilla-central/pushloghtml?changeset=098c543f74c6)|Backed out changeset 2b3af7022014 (bug 1502733) for raptor Android timeout errors.|2018-12-03 01:31:10|
...
|[Link to commit](https://hg.mozilla.org/releases/mozilla-esr60/pushloghtml?changeset=7a8060fc91cd)|Bug 1391756 - Try to fix rare timeout in dom/tests/mochitest/fetch/test_readableStreams.html. r=baku, a=test-only  Also removes an infinite regress of nested iframes. The original problem was that tests would start running before the child iframe was done loading. The straightforward fix is to have the child frame start the test. But this caused further error messages because the child iframe is loaded more than once; removing the iframe from the iframe fixes this.  Differential Revision: https://phabricator.services.mozilla.com/D13385|2018-11-29 22:35:04|
|[Link to commit](https://hg.mozilla.org/releases/mozilla-esr60/pushloghtml?changeset=db9f8b0634ec)|Bug 1499440 - add esr60/release configs for mark-as-started task.r=aki a=release|2018-10-18 19:32:39|
...
|      Repository      |                   Last commit               |    Deploy time       | 
|:--------------------:|:-------------------------------------------:|:--------------------:| 
|[Link to commit](https://hg.mozilla.org/releases/mozilla-release/pushloghtml?changeset=f040763d99ad)|Update configs. IGNORE BROKEN CHANGESETS CLOSED TREE NO BUG a=release ba=release|2018-12-03 15:33:47|
|[Link to commit](https://hg.mozilla.org/releases/mozilla-release/pushloghtml?changeset=ca7d2e41bb01)|No bug - Tagging mozilla-release 0010639216223e5f5fcf753bb64fb93588d787bd with FIREFOX_RELEASE_63_END a=release DONTBUILD CLOSED TREE|2018-12-03 15:29:01|
|[Link to commit](https://hg.mozilla.org/releases/mozilla-release/pushloghtml?changeset=09ecade3ebaa)|Preserve old tags after debugsetparents. CLOSED TREE DONTBUILD a=release|2018-12-03 15:28:58|
|[Link to commit](https://hg.mozilla.org/releases/mozilla-release/pushloghtml?changeset=91ff80fb4297)|Merge old head via |hg debugsetparents 36afbf7b676c904b00ec0f032148d98655267c37 0010639216223e5f5fcf753bb64fb93588d787bd|. CLOSED TREE DONTBUILD a=release|2018-12-03 15:28:52|
|[Link to commit](https://hg.mozilla.org/releases/mozilla-release/pushloghtml?changeset=36afbf7b676c)|No bug - Tagging mozilla-beta e4535e943651ce499a93bbc4592cb16adab897bd with FIREFOX_RELEASE_64_BASE a=release DONTBUILD CLOSED TREE|2018-12-03 15:26:20|
...
|[Link to commit](https://github.com/taskcluster/taskcluster-queue/commit/0e7810781f5e64b1ef06a01f97abf85830e024c9)|Bug 1456909 - use monitor.oneShot()|2018-11-26 19:30:30|
