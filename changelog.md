##  Commits in production - for 3 days, generated on: 2019-04-09 07:44:55 UTC.
|	autoland	|	[MarkDown](https://github.com/mozilla-releng/firefox-infra-changelog/blob/master/hg_files/autoland.md)	|	[Json](https://github.com/mozilla-releng/firefox-infra-changelog/blob/master/hg_files/autoland.json)	| 
|:----------:|:-----------------------:|:--------:| 
 
| Link | Last commit | Author | Reviewer | Deploy time | 
|:----------:|:-----------:|:------:|:--------:|:-----------:| 
|[Link](https://hg.mozilla.org/integration/autoland/pushloghtml?changeset=e6d48028244b)|[Bug 1540907](https://bugzilla.mozilla.org/show_bug.cgi?id=1540907)  - Bump MinGW version to pick up MFVideoTransferMatrix constants r=froydnj Differential Revision: https://phabricator.services.mozilla.com/D26530|apavel@mozilla.com|froydnj|2019-04-09 02:21:13|
...
| Link | Last commit | Author | Reviewer | Deploy time | 
|:----------:|:-----------:|:------:|:--------:|:-----------:| 
|[Link](https://hg.mozilla.org/integration/mozilla-inbound/pushloghtml?changeset=0fbc141c1004)|[Bug 1542824](https://bugzilla.mozilla.org/show_bug.cgi?id=1542824)  - [Coverity] Limit Coverity to run only on try. r=bastien Differential Revision: https://phabricator.services.mozilla.com/D26571|rmaries@mozilla.com|bastien|2019-04-09 06:49:06|
|[Link](https://hg.mozilla.org/integration/mozilla-inbound/pushloghtml?changeset=f6bf51e87b1a)|[Bug 1534647](https://bugzilla.mozilla.org/show_bug.cgi?id=1534647)  - Switch python3 version to 3.6 on osx hosts; r=ahal Quick fix for python3 mozbase perma-fail on osx: Use python 3.6 explicitly, rather than the system default 3.7, which appears to be broken currently (lacking ssl support). Differential Revision: https://phabricator.services.mozilla.com/D26345|rmaries@mozilla.com|ahal|2019-04-09 06:49:06|
...
| Link | Last commit | Author | Reviewer | Deploy time | 
|:----------:|:-----------:|:------:|:--------:|:-----------:| 
|[Link](https://hg.mozilla.org/mozilla-central/pushloghtml?changeset=0fbc141c1004)|[Bug 1542824](https://bugzilla.mozilla.org/show_bug.cgi?id=1542824)  - [Coverity] Limit Coverity to run only on try. r=bastien Differential Revision: https://phabricator.services.mozilla.com/D26571|rmaries@mozilla.com|bastien|2019-04-09 06:43:40|
|[Link](https://hg.mozilla.org/mozilla-central/pushloghtml?changeset=f6bf51e87b1a)|[Bug 1534647](https://bugzilla.mozilla.org/show_bug.cgi?id=1534647)  - Switch python3 version to 3.6 on osx hosts; r=ahal Quick fix for python3 mozbase perma-fail on osx: Use python 3.6 explicitly, rather than the system default 3.7, which appears to be broken currently (lacking ssl support). Differential Revision: https://phabricator.services.mozilla.com/D26345|rmaries@mozilla.com|ahal|2019-04-09 06:43:40|
...
| Link | Last commit | Author | Reviewer | Deploy time | 
|:----------:|:-----------:|:------:|:--------:|:-----------:| 
|[Link](https://hg.mozilla.org/releases/mozilla-release/pushloghtml?changeset=486b34283c44)|[Bug 1541693](https://bugzilla.mozilla.org/show_bug.cgi?id=1541693)  Stop marking releases as started r=mtabara a=release Ship-it v1 is going away soon and we won't need to create new releases in Ship-it v1 in parallel with Ship-it v2. It's time to prep patches to remove this functionality. Differential Revision: https://phabricator.services.mozilla.com/D26044|raliiev@mozilla.com|mtabara|2019-04-09 04:48:47|
