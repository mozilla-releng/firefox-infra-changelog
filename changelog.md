...
| Link | Last commit | Author | Reviewer | Deploy time | 
|:----------:|:-----------:|:------:|:--------:|:-----------:| 
|[Link](https://hg.mozilla.org/integration/mozilla-inbound/pushloghtml?changeset=58dec282b0bc)|[Bug 1491371 ](https://bugzilla.mozilla.org/show_bug.cgi?id=1491371) - Pin comm branches to mozilla revs without .taskcluster.yml. r=tomprince,dustin comm-task-env runs before run-task and updates the environment with GECKO_* variables that are defined in a file at the root of the comm repository, ".gecko_rev.yml". run-task needs these variables to be set to find the correct mozilla repository to check out for a particular TB build. The current pinning method of updating ".taskcluster.yml" with the mozilla repository and revision to pin tois no longer supported. Differential Revision: https://phabricator.services.mozilla.com/D16783|opoprus@mozilla.com|tomprince,dustin|2019-03-19 18:41:04|
|[Link](https://hg.mozilla.org/integration/mozilla-inbound/pushloghtml?changeset=770808176c5c)|[Bug 1491371 ](https://bugzilla.mozilla.org/show_bug.cgi?id=1491371) - Update decision task image to support comm-task-env. r=dustin comm-task-env runs before run-task and updates the environment with GECKO_* variables that are defined in a file at the root of a subproject's repository, such as "comm-central". Updates: - add comm-task-env - add python 3.5 (run-task dependency) - add pyyaml Differential Revision: https://phabricator.services.mozilla.com/D16934|opoprus@mozilla.com|dustin|2019-03-19 18:41:04|
...
| Link | Last commit | Author | Reviewer | Deploy time | 
|:----------:|:-----------:|:------:|:--------:|:-----------:| 
|[Link](https://hg.mozilla.org/mozilla-central/pushloghtml?changeset=58dec282b0bc)|[Bug 1491371 ](https://bugzilla.mozilla.org/show_bug.cgi?id=1491371) - Pin comm branches to mozilla revs without .taskcluster.yml. r=tomprince,dustin comm-task-env runs before run-task and updates the environment with GECKO_* variables that are defined in a file at the root of the comm repository, ".gecko_rev.yml". run-task needs these variables to be set to find the correct mozilla repository to check out for a particular TB build. The current pinning method of updating ".taskcluster.yml" with the mozilla repository and revision to pin tois no longer supported. Differential Revision: https://phabricator.services.mozilla.com/D16783|opoprus@mozilla.com|tomprince,dustin|2019-03-19 18:30:13|
|[Link](https://hg.mozilla.org/mozilla-central/pushloghtml?changeset=770808176c5c)|[Bug 1491371 ](https://bugzilla.mozilla.org/show_bug.cgi?id=1491371) - Update decision task image to support comm-task-env. r=dustin comm-task-env runs before run-task and updates the environment with GECKO_* variables that are defined in a file at the root of a subproject's repository, such as "comm-central". Updates: - add comm-task-env - add python 3.5 (run-task dependency) - add pyyaml Differential Revision: https://phabricator.services.mozilla.com/D16934|opoprus@mozilla.com|dustin|2019-03-19 18:30:13|
